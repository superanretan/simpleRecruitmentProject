...
public class GridObjectsPairing
{
    ...
    public void SetGridObjectsPairing(SceneObjectSo sceneObjectSo, SceneObject sceneObject, GridObject gridObject)
    {
...
public class MenuSceneObjectsManager : MonoBehaviour
{
    ...
    private List<SceneObject> _sceneObjectsList = new List<SceneObject>();
    ...
    {
        if (sceneParent.GetComponentsInChildren<SceneObject>() != null)
            _sceneObjectsList.AddRange(sceneParent.GetComponentsInChildren<SceneObject>());
        else
        {
